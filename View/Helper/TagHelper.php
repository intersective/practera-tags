 ...
 */
	...
	public function input($field, $namespace, $options=array()) {
		...
		echo $this->Form->input($field, array('type' => 'text', 'label' => false, 'legend' => false, 'div' => false, 'data-provide'=>'tag', 'placeholder' => $options['tag_placeholder'], 'data-placeholder' => $options['tag_placeholder'], 'url' => $this->Html->url(array('plugin' => 'storage', 'admin' => false, 'controller' => 'filestores', 'action'=>'autocomplete_tags')) . ".json", 'namespace' => $namespace));
